//Plus.jsx
//add our icons as vectors in .jsx file format
//this is the icons that will allow you add a task to the list
const Plus = () => {
  return (
    //exported these SVG's directly from Figma, refractored into JSX and put it in our assets folder
    <svg
      width="16"
      height="16"
      viewBox="0 0 16 16"
